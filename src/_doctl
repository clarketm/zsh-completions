...
_doctl_1-click_list()
{
    last_command="doctl_1-click_list"
...
_doctl_apps_create()
{
    last_command="doctl_apps_create"
...
_doctl_apps_create-deployment()
{
    last_command="doctl_apps_create-deployment"
    ...
    flags+=("--force-rebuild")
    local_nonpersistent_flags+=("--force-rebuild")
    flags+=("--format=")
    local_nonpersistent_flags+=("--format=")
    flags+=("--no-header")
    local_nonpersistent_flags+=("--no-header")
...
_doctl_apps_delete()
{
    last_command="doctl_apps_delete"
...
_doctl_apps_get-deployment()
{
    last_command="doctl_apps_get-deployment"
...
_doctl_apps_list-deployments()
{
    last_command="doctl_apps_list-deployments"
...
_doctl_apps_list-regions()
{
    last_command="doctl_apps_list-regions"
...
_doctl_apps_spec_get()
{
    last_command="doctl_apps_spec_get"
...
_doctl_apps_spec_validate()
{
    last_command="doctl_apps_spec_validate"
...
_doctl_apps_tier_get()
{
    last_command="doctl_apps_tier_get"
...
_doctl_apps_tier_instance-size_get()
{
    last_command="doctl_apps_tier_instance-size_get"
...
_doctl_apps_tier_instance-size_list()
{
    last_command="doctl_apps_tier_instance-size_list"
...
_doctl_apps_tier_instance-size()
{
    last_command="doctl_apps_tier_instance-size"
...
_doctl_apps_tier_list()
{
    last_command="doctl_apps_tier_list"
...
_doctl_apps_tier()
{
    last_command="doctl_apps_tier"

    command_aliases=()

    commands=()
    commands+=("get")
    commands+=("instance-size")
    commands+=("list")
...
_doctl_apps_update()
{
    last_command="doctl_apps_update"
...
_doctl_apps()
{
    ...
    if [[ -z "${BASH_VERSION}" || "${BASH_VERSINFO[0]}" -gt 3 ]]; then
        command_aliases+=("cd")
        aliashash["cd"]="create-deployment"
    fi
    commands+=("delete")
    if [[ -z "${BASH_VERSION}" || "${BASH_VERSINFO[0]}" -gt 3 ]]; then
        command_aliases+=("d")
    ...
    if [[ -z "${BASH_VERSION}" || "${BASH_VERSINFO[0]}" -gt 3 ]]; then
        command_aliases+=("lsd")
        aliashash["lsd"]="list-deployments"
    fi
    commands+=("list-regions")
    commands+=("logs")
    if [[ -z "${BASH_VERSION}" || "${BASH_VERSINFO[0]}" -gt 3 ]]; then
        command_aliases+=("l")
        aliashash["l"]="logs"
...
_doctl_compute_droplet_1-click_list()
{
    last_command="doctl_compute_droplet_1-click_list"
...
_doctl_compute_droplet_1-click()
{
    last_command="doctl_compute_droplet_1-click"
...
_doctl_compute_droplet_create()
{
    ...
    flags+=("--vpc-uuid=")
    local_nonpersistent_flags+=("--vpc-uuid=")
    flags+=("--wait")
...
_doctl_compute_volume-action_get()
{
    last_command="doctl_compute_volume-action_get"
...
_doctl_compute_volume-action_list()
{
    last_command="doctl_compute_volume-action_list"
...
_doctl_databases_firewalls_append()
{
    last_command="doctl_databases_firewalls_append"
...
_doctl_databases_firewalls_list()
{
    last_command="doctl_databases_firewalls_list"
...
_doctl_databases_firewalls_remove()
{
    last_command="doctl_databases_firewalls_remove"
...
_doctl_databases_firewalls_replace()
{
    last_command="doctl_databases_firewalls_replace"
...
_doctl_databases_firewalls()
{
    last_command="doctl_databases_firewalls"
...
_doctl_kubernetes_1-click_install()
{
    last_command="doctl_kubernetes_1-click_install"
    ...
    flags+=("--1-clicks=")
    local_nonpersistent_flags+=("--1-clicks=")
    flags+=("--format=")
    local_nonpersistent_flags+=("--format=")
    flags+=("--no-header")
    local_nonpersistent_flags+=("--no-header")
...
_doctl_kubernetes_1-click_list()
{
    last_command="doctl_kubernetes_1-click_list"
...
_doctl_kubernetes_1-click()
{
    last_command="doctl_kubernetes_1-click"
...
_doctl_kubernetes_cluster_create()
{
    ...
    local_nonpersistent_flags+=("--size=")
    flags+=("--surge-upgrade")
    local_nonpersistent_flags+=("--surge-upgrade")
    flags+=("--tag=")
    local_nonpersistent_flags+=("--tag=")
...
_doctl_kubernetes_cluster_delete()
{
    ...
    flags+=("--dangerous")
    local_nonpersistent_flags+=("--dangerous")
    flags+=("--force")
    flags+=("-f")
    local_nonpersistent_flags+=("--force")
    flags+=("--update-kubeconfig")
...
_doctl_kubernetes_cluster_delete-selective()
{
    last_command="doctl_kubernetes_cluster_delete-selective"
    ...
    local_nonpersistent_flags+=("--load-balancers=")
    flags+=("--snapshots=")
    local_nonpersistent_flags+=("--snapshots=")
    flags+=("--update-kubeconfig")
    local_nonpersistent_flags+=("--update-kubeconfig")
    flags+=("--volumes=")
    local_nonpersistent_flags+=("--volumes=")
...
_doctl_kubernetes_cluster_list-associated-resources()
{
    last_command="doctl_kubernetes_cluster_list-associated-resources"
...
_doctl_kubernetes_cluster_node-pool_create()
{
    ...
    local_nonpersistent_flags+=("--tag=")
    flags+=("--taint=")
    local_nonpersistent_flags+=("--taint=")
    flags+=("--access-token=")
    two_word_flags+=("-t")
    flags+=("--api-url=")
    two_word_flags+=("-u")
...
_doctl_kubernetes_cluster_registry_add()
{
    last_command="doctl_kubernetes_cluster_registry_add"
...
_doctl_kubernetes_cluster_registry_remove()
{
    last_command="doctl_kubernetes_cluster_registry_remove"
...
_doctl_kubernetes_cluster_registry()
{
    last_command="doctl_kubernetes_cluster_registry"
...
_doctl_kubernetes_cluster()
{
    ...
    commands+=("delete-selective")
    if [[ -z "${BASH_VERSION}" || "${BASH_VERSINFO[0]}" -gt 3 ]]; then
        command_aliases+=("ds")
        aliashash["ds"]="delete-selective"
    fi
    commands+=("get")
    if [[ -z "${BASH_VERSION}" || "${BASH_VERSINFO[0]}" -gt 3 ]]; then
        command_aliases+=("g")
    ...
    commands+=("list-associated-resources")
    if [[ -z "${BASH_VERSION}" || "${BASH_VERSINFO[0]}" -gt 3 ]]; then
        command_aliases+=("ar")
        aliashash["ar"]="list-associated-resources"
    fi
    commands+=("node-pool")
    if [[ -z "${BASH_VERSION}" || "${BASH_VERSINFO[0]}" -gt 3 ]]; then
...
_doctl_registry_create()
{
    last_command="doctl_registry_create"
    ...
    flags+=("--subscription-tier=")
    local_nonpersistent_flags+=("--subscription-tier=")
    flags+=("--access-token=")
    two_word_flags+=("-t")
    flags+=("--api-url=")
    two_word_flags+=("-u")
...
_doctl_registry_delete()
{
    last_command="doctl_registry_delete"
...
_doctl_registry_docker-config()
{
    last_command="doctl_registry_docker-config"
    ...
    local_nonpersistent_flags+=("--expiry-seconds=")
    flags+=("--read-write")
    local_nonpersistent_flags+=("--read-write")
    flags+=("--access-token=")
    two_word_flags+=("-t")
    flags+=("--api-url=")
    two_word_flags+=("-u")
...
_doctl_registry_garbage-collection_cancel()
{
    last_command="doctl_registry_garbage-collection_cancel"
...
_doctl_registry_garbage-collection_get-active()
{
    last_command="doctl_registry_garbage-collection_get-active"
...
_doctl_registry_garbage-collection_list()
{
    last_command="doctl_registry_garbage-collection_list"
...
_doctl_registry_garbage-collection_start()
{
    last_command="doctl_registry_garbage-collection_start"
    ...
    flags+=("--exclude-unreferenced-blobs")
    local_nonpersistent_flags+=("--exclude-unreferenced-blobs")
    flags+=("--force")
    flags+=("-f")
    local_nonpersistent_flags+=("--force")
    flags+=("--format=")
    local_nonpersistent_flags+=("--format=")
    flags+=("--include-untagged-manifests")
    local_nonpersistent_flags+=("--include-untagged-manifests")
    flags+=("--no-header")
    local_nonpersistent_flags+=("--no-header")
    flags+=("--access-token=")
    two_word_flags+=("-t")
...
_doctl_registry_garbage-collection()
{
    last_command="doctl_registry_garbage-collection"
    ...
    if [[ -z "${BASH_VERSION}" || "${BASH_VERSINFO[0]}" -gt 3 ]]; then
        command_aliases+=("g")
        aliashash["g"]="get-active"
        command_aliases+=("ga")
        aliashash["ga"]="get-active"
    fi
    commands+=("list")
    if [[ -z "${BASH_VERSION}" || "${BASH_VERSINFO[0]}" -gt 3 ]]; then
        command_aliases+=("l")
...
_doctl_registry_get()
{
    last_command="doctl_registry_get"
...
_doctl_registry_kubernetes-manifest()
{
    last_command="doctl_registry_kubernetes-manifest"
...
_doctl_registry_login()
{
    last_command="doctl_registry_login"
...
_doctl_registry_logout()
{
    last_command="doctl_registry_logout"
...
_doctl_registry_options_subscription-tiers()
{
    last_command="doctl_registry_options_subscription-tiers"
...
_doctl_registry_options()
{
    last_command="doctl_registry_options"

    command_aliases=()

    commands=()
    commands+=("subscription-tiers")
    if [[ -z "${BASH_VERSION}" || "${BASH_VERSINFO[0]}" -gt 3 ]]; then
        command_aliases+=("tiers")
        aliashash["tiers"]="subscription-tiers"
    fi
...
_doctl_registry_repository_delete-manifest()
{
    last_command="doctl_registry_repository_delete-manifest"
...
_doctl_registry_repository_delete-tag()
{
    last_command="doctl_registry_repository_delete-tag"
...
_doctl_registry_repository_list()
{
    last_command="doctl_registry_repository_list"
...
_doctl_registry_repository_list-tags()
{
    last_command="doctl_registry_repository_list-tags"
...
_doctl_registry_repository()
{
    last_command="doctl_registry_repository"
    ...
    if [[ -z "${BASH_VERSION}" || "${BASH_VERSINFO[0]}" -gt 3 ]]; then
        command_aliases+=("dm")
        aliashash["dm"]="delete-manifest"
    fi
    commands+=("delete-tag")
    if [[ -z "${BASH_VERSION}" || "${BASH_VERSINFO[0]}" -gt 3 ]]; then
        command_aliases+=("dt")
        aliashash["dt"]="delete-tag"
    fi
    commands+=("list")
    if [[ -z "${BASH_VERSION}" || "${BASH_VERSINFO[0]}" -gt 3 ]]; then
        command_aliases+=("ls")
...
_doctl_registry()
{
    ...
    commands+=("docker-config")
    if [[ -z "${BASH_VERSION}" || "${BASH_VERSINFO[0]}" -gt 3 ]]; then
        command_aliases+=("config")
        aliashash["config"]="docker-config"
    fi
    commands+=("garbage-collection")
    if [[ -z "${BASH_VERSION}" || "${BASH_VERSINFO[0]}" -gt 3 ]]; then
        command_aliases+=("g")
        aliashash["g"]="garbage-collection"
        command_aliases+=("gc")
        aliashash["gc"]="garbage-collection"
    fi
    commands+=("get")
    if [[ -z "${BASH_VERSION}" || "${BASH_VERSINFO[0]}" -gt 3 ]]; then
        command_aliases+=("g")
    ...
    commands+=("kubernetes-manifest")
    if [[ -z "${BASH_VERSION}" || "${BASH_VERSINFO[0]}" -gt 3 ]]; then
        command_aliases+=("k8s")
        aliashash["k8s"]="kubernetes-manifest"
    fi
    commands+=("login")
    commands+=("logout")
    commands+=("options")
